...
export default function PosterPreview({ posterRef }: PosterPreviewProps) {
  const {
    ...
    textColor, fontFamily, textAlign, lineHeight,
    showGuides, bgImage, activeCorner,
    ...
    <div className="poster-container overflow-hidden w-full h-full flex items-center justify-center bg-gray-100" ref={containerRef}>
        ...
        >
            ...
            >
                ...
                <div className="absolute inset-0" style={{ padding: '36px 27px' }}>
                    <div className="relative w-full h-full pointer-events-none">
                        
                        <Rnd {...getRndProps(cleanHeaderPos, setHeaderPos)} style={{ zIndex: 10, pointerEvents: 'auto' }}>
                            <div 
                              className="header-text w-full h-full" 
                              style={{ fontSize: `${headerSize}px`, color: textColor, textAlign, lineHeight }} 
                        ...
                        <Rnd {...getRndProps(cleanHadithPos, setHadithPos)} style={{ zIndex: 10, pointerEvents: 'auto' }}>
                            <div 
                              className="main-hadith w-full h-full" 
                              style={{ fontSize: `${hadithSize}px`, color: textColor, textAlign, lineHeight }} 
                        ...
                        <Rnd {...getRndProps(cleanRefPos, setRefPos)} style={{ zIndex: 10, pointerEvents: 'auto' }}>
                            <div 
                              className="reference w-full h-full" 
                              style={{ fontSize: `${refSize}px`, color: textColor, textAlign, lineHeight }} 
